...
def test_collect_articles_uses_demo_collector_by_default(monkeypatch) -> None:
...
def test_collect_articles_uses_news_collector_when_configured(monkeypatch) -> None:
